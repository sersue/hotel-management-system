  ...
  <React.Fragment>
      ...
      <main className={classes.layout}>
        <Paper className={classes.paper}>
          <img src='images/ondol2.jpeg' className={classes.image} align="top" align="right" border="1"></img>
      ...
      <Typography className={classes.title} variant="h6" >
        ...
        <Grid>바닥 온돌, 욕실(화장실과 분리된 타입), 화장실(욕실과 분리된 타입), 인터넷 접속용</Grid>
        <Grid>Wi-Fi 환경, 공기청정기(가습기용)</Grid>
      <Typography className={classes.title} variant="h6" >
        객실 어메니티
      </Typography>
