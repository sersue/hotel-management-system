...
export default function TripleRoom() {
  ...
  <React.Fragment>
      ...
      <Paper className={classes.paper}>
      <img src='images/triple.jpeg' className={classes.image}></img>
      <img src='images/triple0.jpg' className={classes.image}></img>
