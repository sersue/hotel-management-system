...
export default function SweetRoom() {
  ...
  <React.Fragment>
      ...
      <Grid className={classes.title} >
        <Grid>객실크기 : 40m2</Grid>
        <Grid>침대크기 : 더블배드 2개</Grid>
      </Grid>
      <Typography className={classes.title} variant="h6" >
        객실시설
      </Typography>
        <Grid>거실, 욕실(화장실과 분리된 타입), 화장실(욕실과 분리된 타입), 인터넷 접속용 Wi-Fi 환경, 공기청정기(가습기용)</Grid>
      <Typography className={classes.title} variant="h6" >
        객실 어메니티
      </Typography>
      ...
      <Paper className={classes.paper}>
      <img src='images/sweet.jpeg' className={classes.image}></img>
      <img src='images/room1111.jpg' className={classes.image}></img>
